<h1> Rapid deployment of the Waline on Alibaba Cloud compute nest </h1>
...
<p>
    GitHub address of this project: <a href='https://github.com/walinejs/waline'>https://github.com/walinejs/waline</a></p>

<h2> Prerequisites </h2>

<p><font style="color:rgb(51, 51, 51);"> To deploy a Waline community edition service instance, you need to
...
<p><font style="color:rgb(51, 51, 51);"> The cost of Waline deployment in computing nest
...
<table>
    ...
    <tr>
        <td></td>
        <td><font style="color:rgb(51, 51, 51);"> System disk type </font></td>
        <td><font style="color:rgb(51, 51, 51);"> System disk specifications supported by ECS instance types </font></td>
    </tr>
    <tr>
